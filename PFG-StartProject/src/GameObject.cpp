...
void GameObject::SetRotationOnAxis(glm::vec3 axis)
{
	_modelMatrix = glm::rotate(_modelMatrix, _rotation.y, axis);
	_invModelMatrix = glm::rotate(glm::mat4(1.0f), -_rotation.y, axis);
}
